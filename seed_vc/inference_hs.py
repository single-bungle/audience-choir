...
use this command for install all the modules that used

pip install -r requirtments-mac.txt
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source", type=str, default="./examples/source/Wiz Khalifa,Charlie Puth - See You Again [vocals]_[cut_28sec].wav")
    #parser.add_argument("--source", type=str, default="/Users/user/Desktop/python/datasets/singing_voice/yesterday_hs_44100.wav")
    parser.add_argument("--target", type=str, default="./examples/reference/trump_0.wav")
    #parser.add_argument("--target", type=str, default="/Users/user/Desktop/python/datasets/VCTK_Datasets/DS_10283_2651/VCTK-Corpus/wav48/p225/p225_005.wav")
    parser.add_argument("--output", type=str, default="./reconstructed_docker")
